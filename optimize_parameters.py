...
parameters.append(Integer(1, 5, name='min_samples_leaf'))
parameters.append(Real(0.0, 0.5, name='ccp_alpha'))
...
# define the space of hyperparameters to search
parameters = list()
parameters.append(Integer(10, 2000, 'log-uniform', name='n_estimators'))
